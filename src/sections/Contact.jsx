...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "louisseangelosapaula@gmail.com",
    href: "mailto:louisseangelosapaula@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+639561393132",
    href: "tel:+639561393132",
  },
  {
    icon: MapPin,
    label: "Location",
    value: "Bulakan, Bulacan",
    href: "https://share.google/BaJkztK4neqZPwAHD",
  },
];
      ...
      <div className="container mx-auto p-1 md:px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 px-3 md:px-0">
          ...
          <p className="text-muted-foreground animate-fade-in animation-delay-200">
            Ready to Contribute my Skills, Knowledge, and Passion.
          </p>
        </div>
              ...
              <div className="space-y-4">
                {contactInfo.map((item, i) => (
                  <a
                    key={i}
                    href={item.href}
                    className="flex items-center gap-3 md:gap-4 p-2 md:p-4 rounded-xl hover:bg-surface transition-colors group"
                  >
